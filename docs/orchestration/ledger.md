...
| R6-03 V2 Visual Integration | `019ff9e2-b2bb-7501-bcaa-071b1ae28fe5` | `in_progress` | `in_progress` | `codex/r6-03-visual-integration` | `85baa9a` | — | — | — | R6-02 Range Data; release gate | Real DTO wiring, paced Bot playback, Fast Solver/Advisor/Range/Stats rail, V2 product entry and four-resolution browser smoke |
