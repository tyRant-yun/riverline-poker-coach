...
| R5-03 Local Experience | `019ff53a-fe87-7353-b7cc-ac3288f0553e` | `in_progress` | `in_progress` | `codex/r5-03-local-experience` | `a85784c` | — | — | — | stage release gate | Default SQLite/no-Redis one-click start, health wait/logs, and focused multiseat Playwright stabilization |
