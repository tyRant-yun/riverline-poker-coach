...
| R5-06 Fast Solver L1 | `019ff500-f1ba-7af2-9663-5c4aa1826bf6` | `completed` | `pending_acceptance` | `codex/r5-06-fast-solver` | `6524fd6` | `cf665da9773942664d0ab43cd97c689cec0aff55` | [R5-06 handoff](handoffs/R5-06.md) | Backend 19 passed; frontend 6 passed; compileall/tsc; 120-iteration multiway flop 4.263ms | focused solver/privacy review; R6-03 | Awaiting legal-action/EV/privacy/stale-response P0/P1 review before integration |
| R6-01 Table Visual System + Playback | `019ff9e2-b2bb-7501-bcaa-071b1ae28fe5` | `in_progress` | `in_progress` | `codex/r6-01-table-visual-system` | `6524fd6` | — | — | — | R6-03 integration | New-file-only professional table components, reserved pot/board geometry, paced action queue, accessible Hero dock and insight rail; no current page/API overlap |

## 下一入口

`R5-06 + R6-01`：两实现槽文件所有权分离。R5-06 负责异步限时近似 EV Solver 和现有页面最小接线；R6-01 仅新增专业牌桌/动作播放/洞察展示组件，不修改当前 page/API。两项验收后由 R6-03 统一接线，再启动 Range 数据可用性修复。
