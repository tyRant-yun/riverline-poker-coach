...
| R5-06 Fast Solver L1 | `019ff500-f1ba-7af2-9663-5c4aa1826bf6` | `in_progress` | `in_progress` | `codex/r5-06-fast-solver` | `b621148` | — | — | — | focused solver/privacy review; release gate | Reuse Formula Advisor Worker; bounded approximate EV search, honest provenance, timeout/fallback, table Solver panel |
