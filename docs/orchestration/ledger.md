...
| R6-03B V2 Visual Integration | `019ff9fe-49f7-7080-90d8-c5efcd61b954` | `in_progress` | `in_progress` | `codex/r6-03b-visual-integration` | current origin tip | — | — | — | R6-02 Range Data; release gate | Replacement task is confirmed active; real DTO wiring, paced playback, Solver/Range rail, V2 entry and four-resolution browser smoke |
