...
known hole cards, player actions, board deals, completion and PokerKit-derived
payouts.  The product default remains 6-max, 100BB, no ante and no rake.
...
Import accepts only completed hands.  PokerKit validates PHH syntax/state, then
