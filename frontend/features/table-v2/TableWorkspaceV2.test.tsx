...
describe("Table V2 visual contracts", () => {
  ...
  it("shows readable seat range summary, expandable heatmap, localized tooltips, stats, and approximate solver limitations", () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "Range" })); expect(screen.getByText(/范围宽度 28.5%/)).toBeInTheDocument(); expect(screen.getByText(/近似：100BB 最近档/)).toBeInTheDocument();
